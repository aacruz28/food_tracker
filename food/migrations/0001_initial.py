    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cholesterol', models.FloatField(null=True, verbose_name='Cholesterol (mg)')),
                ('sodium', models.FloatField(null=True, verbose_name='Sodium (mg)')),
                ('total_carbohydrate', models.FloatField(null=True, verbose_name='Total Carbohydrate (g)')),
                ('dietary_fiber', models.FloatField(null=True, verbose_name='Dietary Fiber (g)')),
                ('sugar', models.FloatField(null=True, verbose_name='Sugar (g)')),
                ('protein', models.FloatField(null=True, verbose_name='Protein (g)')),
            ],
        ),
        migrations.CreateModel(
            name='Meal',
